---
title: "ProPane: Let's do the Space Warp Again!"
...
The **Rwcs** package comes with key utilities for warping between different WCS systems: **Rwcs_warp** (for warping individual frames once). **ProPane** itself contains the various functions for creating large stacks of many warped frames (which is of class *ProPane*, which is roughly meant to suggest the idea of many *panes* of glass being stacked together). 
...
```{r}
stack_med2 = propaneStackWarpMed(keyvalues_out = keyvalues_out,
